...
export const TRACKS = [
  { id: "earth-world",  name: "地球世界(原創)",      src: "/assets/music.wav",
    credit: "原創配樂 · Claude" },
  { id: "invariance",   name: "Invariance · 沉浸宇宙", src: "/assets/music/invariance.mp3",
    credit: "Kevin MacLeod (incompetech.com) · CC BY 4.0" },
  { id: "achaidh",      name: "Achaidh Cheide · 溫暖民謠", src: "/assets/music/achaidh-cheide.mp3",
    credit: "Kevin MacLeod (incompetech.com) · CC BY 4.0" },
];
